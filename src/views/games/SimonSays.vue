...
<template>
  <div class="simon-says">
    ...
    <p v-if="!gameStarted" class="instructions">Нажмите "Начать игру", чтобы начать.</p>
    ...
    <div class="controls">
      ...
      >
        {{ gameStarted ? (gameOver ? 'Начать заново' : 'Идет игра...') : 'Начать игру' }}
      </el-button>
    </div>
    <el-dialog
        title="Игра окончена"
    ...
    >
      <div>
        ...
        <ul>
          <li v-for="achievement in unlockedAchievements" :key="achievement.key">
