...
export const useFormStore = defineStore('formStore', () => {
	...
	const recommendationsData = ref<RecommendationsData | null>(null);
	...
	const handleSubmit = async () => {
		...
		try {
			...
			// Сохранение данных рекомендаций в магазине
			...
			throw error; // Переброс ошибки, чтобы компонент мог обработать её
		} finally {
			isLoading.value = false;
		}
	};

	// Дополнительные действия для получения данных рекомендаций
	const getRecommendationsData = () => recommendationsData.value;
